...
const ViewProfile = () => {
  ...
  return (
    <>
      <div
        className={`${modal || profileModal || ninSlipError ? "blur" : ""} ${context ? "" : ""
      ...
      >
        ...
        />
        <div
          className={`profile_details col-md-7 col-lg-8 p-0 ${viewProfileData[tabIndex].contentType === "table"
            ? "overflow_table"
            : ""
            }`}
        >
        ...
        <Modal
          ...
          content={
            <SuccessContent
              responseType={"error"}
              responseTexts={
                <> <p>{!ninSlipError ? paymentError : "An Error occured! Please try again!"}</p> <p>{paymentError}</p>
                </>
              }
