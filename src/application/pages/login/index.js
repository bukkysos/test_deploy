              ...
              <div className=" col-11 login_form">
                ...
                <div className="d-flex login_right_terms w-75 p-0 mx-auto p-0 m-0">
                  <div style={{width: "100%", padding: 0}}>
                    <a href="https://nimcmobile.app/terms" rel="noreferrer" className="p-0 ">Terms</a>
                    <a href="https://nimcmobile.app/privacy" target="_blank" rel="noreferrer" className="p-0 ">Privacy</a>
                    <a href="mailto:mobileid@nimc.gov.ng" className="p-0 ">Contact</a>
                  </div>
                </div>
              </div>
            </div>
