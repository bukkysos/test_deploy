...
const GiftCard = ({ getResponse, recipient = null, defaultUserObject = undefined }) => {
    ...
    <>
      <Card>
        <Input
          ...
          error={userIdError}
          errorText={ownIdError ? "Can't send credit to yourself" : "Invalid User ID or Unit(s). Please check your inputs."}
        />
        <div className=" py-3">
          <Input
            placeholder={"0.00"}
