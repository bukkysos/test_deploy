...
!(function (e, t) {
        ...
        x.extend({
            ...
            map: function (e, t, n) {
                var r,
                    ...
                    o = e.length,
                    a = [];
                if (M(e)) for (; o > i; i++) null != (r = t(e[i], i, n)) && (a[a.length] = r);
        ...
        (function (e, t) {
            ...
            ((o = oe.selectors =
                {
                    ...
                    preFilter: {
                        ATTR: function (e) {
                            return (
                                (e[1] = e[1].replace(re, ie)),
                                (e[3] = (e[4] || e[5] || '').replace(re, ie)),
                                '~=' === e[2] && (e[3] = ' ' + e[3] + ' '),
                                e.slice(0, 4)
                            );
                        },
                ...
                return (
                    ...
                    se(function (o, a, s, l) {
                        var u,
                            ...
                            m = !e || (!o && t) ? g : be(g, p, e, s, l),
                            y = n ? (i || (o ? e : h || r) ? [] : a) : m;
                        if ((n && n(m, y, s, l), r))
                            for (u = be(y, d), r(u, [], s, l), c = u.length; c--; )
                                (f = u[c]) && (y[d[c]] = !(m[d[c]] = f));
                        if (o) {
                            if (i || e) {
                                if (i) {
            ...
            function Te(e) {
                for (
                    ...
                    if ((n = o.relative[e[l].type])) p = [ye(ve(p), n)];
                    else {
                ...
                var n = 0,
                    ...
                    s = function (s, l, c, f, d) {
                        ...
                        if (((v += b), r && b !== v)) {
                            ...
                            M.apply(f, y),
                                T && !s && y.length > 0 && v + t.length > 1 && oe.uniqueSort(f);
                        }
                        return T && ((w = k), (u = C)), x;
                    };
                return r ? se(s) : s;
    ...
    (x.Callbacks = function (e) {
            ...
            f = {
                ...
                fireWith: function (e, t) {
                    return (
                        !l ||
                            (i && !u) ||
                            ((t = [e, (t = t || []).slice ? t.slice() : t]), n ? u.push(t) : c(t)),
                        this
                    );
                },
                fire: function () {
        ...
        (x.support = (function (t) {
            ...
            for (p in ((o = a.createElement('input')).setAttribute('value', ''),
            ...
            for (p in ((d.style.backgroundClip = 'content-box'),
            ...
            return (
                ...
                x(function () {
                    ...
                    l &&
                        ...
                        (f = 0 === o[0].offsetHeight),
                        (o[0].style.display = ''),
                        (o[1].style.display = 'none'),
                        (t.reliableHiddenOffsets = f && 0 === o[0].offsetHeight),
                        (d.innerHTML = ''),
                        (d.style.cssText =
                        ...
                        e.getComputedStyle &&
                            ...
                            ((r = d.appendChild(a.createElement('div'))).style.cssText =
                                d.style.cssText =
                                    s),
        ...
        if (x.acceptData(e)) {
            ...
            if ((c && u[c] && (i || u[c].data)) || r !== t || 'string' != typeof n)
                return (
                    ...
                    'string' == typeof n ? null == (o = a[n]) && (o = a[x.camelCase(n)]) : (o = a),
                    o
                );
        }
    }
            ...
            if (a[s]) {
                if (t && (r = n ? a[s] : a[s].data)) {
                    x.isArray(t)
                        ...
                        : t in r
                        ? (t = [t])
                        : (t = (t = x.camelCase(t)) in r ? [t] : t.split(' ')),
                        (i = t.length);
                    for (; i--; ) delete r[t[i]];
                ...
                if (e === t) {
                    if (
                        ...
                        for (r = s.attributes; r.length > a; a++)
                            0 === (i = r[a].name).indexOf('data-') &&
                                W(s, (i = x.camelCase(i.slice(5))), o[i]);
        ...
        x.fn.extend({
            ...
            promise: function (e, n) {
                ...
                for ('string' != typeof e && ((n = e), (e = t)), e = e || 'fx'; s--; )
                    (r = x._data(a[s], e + 'queueHooks')) && r.empty && (i++, r.empty.add(l));
    ...
    x.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return 'boolean' == typeof t && 'string' === n
                ...
                : this.each(function () {
                      if ('string' === n)
                          for (var t, r = 0, o = x(this), a = e.match(w) || []; (t = a[r++]); )
        ...
        x.extend({
                ...
                select: {
                    ...
                    set: function (e, t) {
                        for (var n, r, i = e.options, o = x.makeArray(t), a = i.length; a--; )
                            ((r = i[a]).selected = x.inArray(x(r).val(), o) >= 0) && (n = !0);
            ...
            attr: function (e, n, r) {
                ...
                if (e && 3 !== s && 8 !== s && 2 !== s)
                    return typeof e.getAttribute === i
                        ...
                        : ((1 === s && x.isXMLDoc(e)) ||
                              ((n = n.toLowerCase()),
                              (o = x.attrHooks[n] || (x.expr.match.bool.test(n) ? z : I))),
                          r === t
                              ? o && 'get' in o && null !== (a = o.get(e, n))
                                  ? a
                                  : null == (a = x.find.attr(e, n))
                                  ? t
                                  : a
                              : null !== r
            ...
            prop: function (e, n, r) {
                ...
                if (e && 3 !== a && 8 !== a && 2 !== a)
                    return (
                        (1 !== a || !x.isXMLDoc(e)) &&
                            ((n = x.propFix[n] || n), (o = x.propHooks[n])),
                        r !== t
            ...
            set: function (e, t, n) {
                return (
                    !1 === t
                        ? x.removeAttr(e, n)
                        : (Q && G) || !J.test(n)
                        ? e.setAttribute((!G && x.propFix[n]) || n, n)
    ...
    (x.event = {
                ...
                for (
                            ...
                            ((p = v.handle =
                                function (e) {
                                    return typeof x === i || (e && x.event.triggered === e.type)
                                        ? t
                                        : x.event.dispatch.apply(p.elem, arguments);
                                }).elem = e),
                        u = (n = (n || '').match(w) || ['']).length;
                    u--;
                    ...
                    (g = y = (s = ne.exec(n[u]) || [])[1]),
                        ...
                        g &&
                            ...
                            (h = l[g]) ||
                                (((h = l[g] = []).delegateCount = 0),
                                (f.setup && !1 !== f.setup.call(e, o, m, p)) ||
                                    (e.addEventListener
                                        ? e.addEventListener(g, p, !1)
                                        : e.attachEvent && e.attachEvent('on' + g, p))),
                            f.add &&
        ...
        trigger: function (n, r, i, o) {
            ...
            if (
                ...
                3 !== i.nodeType &&
                    8 !== i.nodeType &&
                    !te.test(g + x.event.triggered) &&
                    (g.indexOf('.') >= 0 && ((m = g.split('.')), (g = m.shift()), m.sort()),
                    (l = 0 > g.indexOf(':') && 'on' + g),
                    ((n = n[x.expando] ? n : new x.Event(g, 'object' == typeof n && n)).isTrigger =
                        o ? 2 : 3),
                    (n.namespace = m.join('.')),
                    ...
                    (f = x.event.special[g] || {}),
                    o || !f.trigger || !1 !== f.trigger.apply(i, r)))
            ) {
                if (!o && !f.noBubble && !x.isWindow(i)) {
                    for (
                        c = f.delegateType || g, te.test(c + g) || (u = u.parentNode);
                        u;
                        u = u.parentNode
                    )
                        h.push(u), (p = u);
                ...
                if (
                    ...
                    !o &&
                        ...
                        (!f._default || !1 === f._default.apply(h.pop(), r)) &&
                        x.acceptData(i) &&
                        l &&
                        i[g] &&
                        !x.isWindow(i))
    ...
    x.fn.extend({
        ...
        closest: function (e, t) {
            for (
                var n,
                    ...
                    i = this.length,
                    o = [],
                    a = le.test(e) || 'string' != typeof e ? x(e, t || this.context) : 0;
                i > r;
                r++
            )
            ...
            function (e, t) {
                x.fn[e] = function (n, r) {
                    ...
                    return (
                        ...
                        this.length > 1 &&
                            (ue[e] || (i = x.unique(i)), se.test(e) && (i = i.reverse())),
                        this.pushStack(i)
                    );
                };
            }
        ...
        x.extend({
            ...
            dir: function (e, n, r) {
                for (
                    var i = [], o = e[n];
                    o && 9 !== o.nodeType && (r === t || 1 !== o.nodeType || !x(o).is(r));
    ...
    function Me(e, n) {
        ...
        if (!s)
            for (s = [], r = e.childNodes || e; null != (o = r[a]); a++)
                !n || x.nodeName(o, n) ? s.push(o) : x.merge(s, Me(o, n));
    ...
    (Se.optgroup = Se.option),
        ...
        x.fn.extend({
            ...
            remove: function (e, t) {
                for (var n, r = e ? x.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                    t || 1 !== n.nodeType || x.cleanData(Me(n)),
                        n.parentNode &&
                            (t && x.contains(n.ownerDocument, n) && He(Me(n, 'script')),
                            n.parentNode.removeChild(n));
                return this;
            },
            empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++) {
                    for (1 === e.nodeType && x.cleanData(Me(e, !1)); e.firstChild; )
                    ...
                    function (e) {
                        ...
                        if (
                            !(
                                'string' != typeof e ||
                                Te.test(e) ||
                                (!x.support.htmlSerialize && ge.test(e)) ||
                                (!x.support.leadingWhitespace && me.test(e)) ||
                                Se[(ve.exec(e) || ['', ''])[1].toLowerCase()]
                            )
                        ) {
                            e = e.replace(ye, '<$1></$2>');
                            try {
                                for (; i > r; r++)
                                    1 === (n = this[r] || {}).nodeType &&
                                        (x.cleanData(Me(n, !1)), (n.innerHTML = e));
                                n = 0;
                            } catch (e) {}
                        }
            ...
            domManip: function (e, t, n) {
                ...
                if (
                    c &&
                    ((r = (l = x.buildFragment(e, this[0].ownerDocument, !1, !n && this))
                        .firstChild),
                    1 === l.childNodes.length && (l = r),
                    r)
                ) {
                    for (o = (a = x.map(Me(l, 'script'), De)).length; c > u; u++)
                        (i = l),
                            u !== p && ((i = x.clone(i, !0, !0)), o && x.merge(a, Me(i, 'script'))),
                            t.call(this[u], i, u);
                    if (o)
                        for (s = a[a.length - 1].ownerDocument, x.map(a, Le), u = 0; o > u; u++)
                            (i = a[u]),
                                Ne.test(i.type || '') &&
        ...
        x.each(
            ...
            function (e, t) {
                x.fn[e] = function (e) {
                    for (var n, r = 0, i = [], o = x(e), a = o.length - 1; a >= r; r++)
        ...
        x.extend({
            clone: function (e, t, n) {
                ...
                if (
                    (x.support.html5Clone || x.isXMLDoc(e) || !ge.test('<' + e.nodeName + '>')
                        ? (o = e.cloneNode(!0))
                ...
                return (
                    (r = Me(o, 'script')).length > 0 && He(r, !l && Me(e, 'script')),
                    (r = s = i = null),
                    o
                );
            },
            buildFragment: function (e, t, n, r) {
                for (var i, o, a, s, l, u, c, f = e.length, p = pe(t), d = [], h = 0; f > h; h++)
                    if ((o = e[h]) || 0 === o)
                        if ('object' === x.type(o)) x.merge(d, o.nodeType ? [o] : o);
                            ...
                            if (
                                (!x.support.leadingWhitespace &&
                                    me.test(o) &&
                                    d.push(t.createTextNode(me.exec(o)[0])),
                                !x.support.tbody)
                            )
                                for (
                                    i =
                                    ...
                                    x.nodeName((u = o.childNodes[i]), 'tbody') &&
                                        !u.childNodes.length &&
                                        o.removeChild(u);
                            for (x.merge(d, s.childNodes), s.textContent = ''; s.firstChild; )
                                s.removeChild(s.firstChild);
                            s = p.lastChild;
                        } else d.push(t.createTextNode(o));
                for (
                    s && p.removeChild(s),
                        x.support.appendChecked || x.grep(Me(d, 'input'), Oe),
                        h = 0;
                    (o = d[h++]);
            ...
            cleanData: function (e, t) {
                for (
                    ...
                    if ((t || x.acceptData(n)) && (a = (o = n[l]) && u[o])) {
                        if (a.events)
                            for (r in a.events)
                                p[r] ? x.event.remove(n, r) : x.removeEvent(n, r, a.handle);
                        u[o] &&
                            (delete u[o],
                            c
                                ? delete n[l]
            ...
            (r = e[a]).style &&
                ...
                t
                    ? (o[a] || 'none' !== n || (r.style.display = ''),
                      '' === r.style.display &&
                          et(r) &&
                          (o[a] = x._data(r, 'olddisplay', ot(r.nodeName))))
                    : o[a] ||
                      ((i = et(r)),
                      ((n && 'none' !== n) || !i) &&
    ...
    function rt(e, t, n, r, i) {
        for (
            ...
            'margin' === n && (a += x.css(e, n + Qe[o], !0, i)),
                r
                    ? ('content' === n && (a -= x.css(e, 'padding' + Qe[o], !0, i)),
                      'margin' !== n && (a -= x.css(e, 'border' + Qe[o] + 'Width', !0, i)))
                    : ((a += x.css(e, 'padding' + Qe[o], !0, i)),
            ...
            n ||
                (('none' !== (n = at(e, t)) && n) ||
                    ((t = (
                        ...
                        ).appendTo(t.documentElement))[0].contentWindow || Fe[0].contentDocument
    ...
    x.fn.extend({
        ...
        x.extend({
            ...
            style: function (e, n, r, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var o,
                        ...
                        u = e.style;
                    if (
                        ((n = x.cssProps[l] || (x.cssProps[l] = Ze(u, l))),
            ...
            css: function (e, n, r, i) {
                var o,
                    ...
                    l = x.camelCase(n);
                return (
                    (n = x.cssProps[l] || (x.cssProps[l] = Ze(e.style, l))),
                    (s = x.cssHooks[n] || x.cssHooks[l]) && 'get' in s && (a = s.get(e, !0, r)),
                    a === t && (a = Pe(e, n, i)),
                    'normal' === a && n in Ge && (a = Ge[n]),
                    '' === r || r
                        ? ((o = parseFloat(a)), !0 === r || x.isNumeric(o) ? o || 0 : a)
                        : a
                );
            }
        }),
              ...
              (Pe = function (e, n, r) {
                  ...
                  return (
                      ...
                      Ue.test(l) &&
                          !$e.test(n) &&
                          ((i = u.left),
                          (a = (o = e.runtimeStyle) && o.left) && (o.left = e.currentStyle.left),
        ...
        x.each(['height', 'width'], function (e, n) {
            x.cssHooks[n] = {
                get: function (e, r, i) {
                    return r
                        ? 0 === e.offsetWidth && Ie.test(x.css(e, 'display'))
                            ? x.swap(e, Je, function () {
                                  return it(e, n, i);
                              })
                            : it(e, n, i)
                        : t;
                ...
                !x.support.pixelPosition &&
                    ...
                    x.each(['top', 'left'], function (e, n) {
                        x.cssHooks[n] = {
                            get: function (e, r) {
                                return r
                                    ? ((r = Pe(e, n)), Ue.test(r) ? x(e).position()[n] + 'px' : r)
                                    : t;
                            }
                        };
                    });
        ...
        x.extend({
            ...
            ajax: function (e, n) {
                ...
                if (
                    ...
                    (C.success = C.done),
                    (C.error = C.fail),
                    (f.url = ((e || f.url || ht) + '').replace(yt, '').replace(Tt, dt[1] + '//')),
                    ...
                    return C;
                for (i in ((l = f.global) && 0 == x.active++ && x.event.trigger('ajaxStart'),
                (f.type = f.type.toUpperCase()),
                (f.hasContent = !xt.test(f.type)),
                (o = f.url),
                f.hasContent ||
                    (f.data && ((o = f.url += (mt.test(o) ? '&' : '?') + f.data), delete f.data),
                    !1 === f.cache &&
                        (f.url = vt.test(o)
                            ? o.replace(vt, '$1_=' + gt++)
                            : o + (mt.test(o) ? '&' : '?') + '_=' + gt++)),
                ...
                C.setRequestHeader(
                    ...
                    f.dataTypes[0] && f.accepts[f.dataTypes[0]]
                        ? f.accepts[f.dataTypes[0]] +
                              ('*' !== f.dataTypes[0] ? ', ' + Et + '; q=0.01' : '')
                        : f.accepts['*']
                ),
                f.headers))
                    C.setRequestHeader(i, f.headers[i]);
                        ...
                        c
                            ? (f.ifModified &&
                                  ((w = C.getResponseHeader('Last-Modified')) &&
                                      (x.lastModified[o] = w),
                                  (w = C.getResponseHeader('etag')) && (x.etag[o] = w)),
                              204 === e || 'HEAD' === f.type
                                  ? (N = 'nocontent')
                                  : 304 === e
                                  ? (N = 'notmodified')
                                  : ((N = T.state), (y = T.data), (c = !(v = T.error))))
                            : ((v = N), (e || !N) && ((N = 'error'), 0 > e && (e = 0))),
                        (C.status = e),
                        (C.statusText = (n || N) + ''),
                        c ? h.resolveWith(p, [y, N, C]) : h.rejectWith(p, [C, N, v]),
                        C.statusCode(m),
                        (m = t),
                        l && d.trigger(c ? 'ajaxSuccess' : 'ajaxError', [C, f, c ? y : v]),
                        g.fireWith(p, [C, N]),
                        l &&
        ...
        x.ajaxPrefilter('json jsonp', function (n, r, i) {
            ...
            return l || 'jsonp' === n.dataTypes[0]
                ? ((o = n.jsonpCallback =
                  ...
                  l
                      ? (n[l] = n[l].replace(Lt, '$1' + o))
                      : !1 !== n.jsonp &&
                        (n.url += (mt.test(n.url) ? '&' : '?') + n.jsonp + '=' + o),
                  ...
                  i.always(function () {
                      (e[o] = a),
                          n[o] && ((n.jsonpCallback = r.jsonpCallback), Dt.push(o)),
    ...
    (x.ajaxSettings.xhr = e.ActiveXObject
        ...
        (x.support.cors = !!qt && 'withCredentials' in qt),
        (qt = x.support.ajax = !!qt) &&
            ...
            function (e, t, n) {
                ...
                1 === e.nodeType &&
                    ...
                    'inline' === x.css(e, 'display') &&
                        'none' === x.css(e, 'float') &&
                        (x.support.inlineBlockNeedsLayout && 'inline' !== ot(e.nodeName)
                            ? (f.zoom = 1)
                ...
                if (!x.isEmptyObject(c))
                    for (r in (d ? 'hidden' in d && (p = d.hidden) : (d = x._data(e, 'fxshow', {})),
                    o && (d.hidden = !p),
                    p
                        ? x(e).show()
                        : u.done(function () {
            ...
            '*': [
                function (e, t) {
                    var n = this.createTween(e, t),
                        ...
                        a = (x.cssNumber[e] || ('px' !== o && +r)) && Rt.exec(x.css(n.elem, e)),
                        s = 1,
                        l = 20;
                    if (a && a[3] !== o) {
                        (o = o || a[3]), (i = i || []), (a = +r || 1);
            ...
            stop: function (e, n, r) {
                ...
                return (
                    ...
                    this.each(function () {
                        ...
                        else for (n in a) a[n] && a[n].stop && Wt.test(n) && i(a[n]);
                        for (n = o.length; n--; )
                            o[n].elem !== this ||
                                (null != e && o[n].queue !== e) ||
        ...
        (x.offset = {
            setOffset: function (e, t, n) {
                ...
                var i,
                    ...
                    c = {},
                    f = {};
                ('absolute' === r || 'fixed' === r) && x.inArray('auto', [l, u]) > -1
                    ? ((i = (f = a.position()).top), (o = f.left))
                    : ((i = parseFloat(l) || 0), (o = parseFloat(u) || 0)),
                    x.isFunction(t) && (t = t.call(e, n, s)),
