    ...
    <>
      <nav className="d-flex justify-content-between m-0">
        <div className="p-0 m-0 my-auto header_left">
          {" "}
          <span className="hamburger_menu pr-3" onClick={() => setSidebarState(!sidebarState)}>
          <Hamburger />
          </span>
          {headerIconDisplay ? (
            <Link to={"/my-dependents"} className="back_link">
              <div className="d-flex justify-content-start nav_back">
                ...
                <p className="p-0 ml-3 my-auto back_text">
                  Back to My Dependents
                </p>
              </div>
            </Link>
          ) : (
            <p className="nimc_text m-0">
            NIMC MobileID
            </p>
          )}
        </div>
        <div className="header_right">
          <ul className="my-auto">
            <li className="header_credits">Credits: { jwt_data?.availablecredit ?? credits}</li>
